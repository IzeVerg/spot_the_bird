        ...
        listener: (previosState, currentState) {
          if (currentState is LocationLoaded) {
            _mapController.onReady
                .then((_) => _mapController.move(LatLng(currentState.latitude, currentState.longitude), 14));
          }
          ...
          builder: (context, birdPostState) {
            return FlutterMap(
              ...
              layers: [
                ...
                MarkerLayerOptions(markers: _buildMarkers(context, birdPostState.birdPosts)),
              ],
            );
          },
        ),
